...
interface DiceRollInterface extends ethers.utils.Interface {
  functions: {
    ...
    "multiplier(bool,uint256)": FunctionFragment;
    "owner()": FunctionFragment;
    "padding()": FunctionFragment;
    "payout(bool,uint256,uint256)": FunctionFragment;
    "play(uint256,uint256,bool,bytes32)": FunctionFragment;
    "profitTaker()": FunctionFragment;
    "rangeMax()": FunctionFragment;
    "rangeMin()": FunctionFragment;
    "renounceOwnership()": FunctionFragment;
    "setBetRange(uint256,uint256)": FunctionFragment;
    "setChoiceRange(uint256,uint256,uint256)": FunctionFragment;
  ...
  encodeFunctionData(functionFragment: "padding", values?: undefined): string;
  encodeFunctionData(
  ...
  encodeFunctionData(functionFragment: "rangeMax", values?: undefined): string;
  encodeFunctionData(functionFragment: "rangeMin", values?: undefined): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setChoiceRange",
  ...
  decodeFunctionResult(functionFragment: "padding", data: BytesLike): Result;
  ...
  decodeFunctionResult(functionFragment: "rangeMax", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "rangeMin", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "renounceOwnership",
    data: BytesLike
  ): Result;
...
export class DiceRoll extends Contract {
  ...
  functions: {
    ...
    padding(overrides?: CallOverrides): Promise<[BigNumber]>;
    ...
    rangeMax(overrides?: CallOverrides): Promise<[BigNumber]>;

    "rangeMax()"(overrides?: CallOverrides): Promise<[BigNumber]>;

    rangeMin(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  populateTransaction: {
    ...
    padding(overrides?: CallOverrides): Promise<PopulatedTransaction>;
    ...
    rangeMax(overrides?: CallOverrides): Promise<PopulatedTransaction>;

    "rangeMax()"(overrides?: CallOverrides): Promise<PopulatedTransaction>;

    rangeMin(overrides?: CallOverrides): Promise<PopulatedTransaction>;
